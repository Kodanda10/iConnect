...
exports.generateCampaignVariations = void 0;
const https_1 = require("firebase-functions/v2/https");
const generative_ai_1 = require("@google/generative-ai");
exports.generateCampaignVariations = (0, https_1.onCall)({ region: 'asia-south1' }, async (request) => {
    if (!request.auth) {
    ...
    if (!apiKey) {
        ...
        if (language === 'ODIA')
            return { variations: [`${eventName} ଉପଲକ୍ଷେ ଆପଣଙ୍କୁ ଓ ଆପଣଙ୍କ ପରିବାରକୁ ହାର୍ଦ୍ଦିକ ଶୁଭେଚ୍ଛା। - ${leaderName}`] };
        if (language === 'HINDI')
            return { variations: [`${eventName} के अवसर पर आपको और आपके परिवार को हार्दिक शुभकामनाएँ। - ${leaderName}`] };
