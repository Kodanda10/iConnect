...
function scanForTasks(constituents, existingTasks, TimestampClass) {
    ...
    const newTasks = [];
    // Pre-compute existing tasks into a Set for O(1) lookups
    ...
    for (const task of existingTasks) {
        ...
        existingTaskSet.add(`${constituentId}_${task.type}_${taskDateStr}`);
    }
    // Extract expensive date string allocations outside the loop
