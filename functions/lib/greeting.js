...
async function generateGreetingMessage(request) {
    ...
    const sanitizedName = (0, security_1.sanitizeInput)(request.name) || 'Constituent';
    const sanitizedLeaderName = request.leaderName ? (0, security_1.sanitizeInput)(request.leaderName) : undefined;
