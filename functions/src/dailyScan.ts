 ...
 * - 2024-05-21: Optimized date matching with string suffix comparison (Bolt)
 */
 ...
 * Optimized to use string suffix check when possible.
 */
function isDateMatch(dateStr: string | undefined, targetSuffix: string, targetDate: Date): boolean {
    if (!dateStr) return false;

    // Fast path: strict YYYY-MM-DD format check by length
    // Avoids expensive split/parseInt operations in hot loops
