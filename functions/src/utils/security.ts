...
/**
 * Sanitizes user input by limiting length, stripping HTML tags,
 * removing standalone angle brackets, and removing control characters
 * to prevent prompt injection and XSS.
 */
