...
/**
 * Sanitizes user input by restricting length to 100 characters,
 * removing HTML tags, standalone angle brackets, and control characters
 * to mitigate XSS and prompt injection attacks.
 */
