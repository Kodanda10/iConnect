...
/**
 * Sanitizes user input to prevent HTML injection and mitigate prompt injection.
 * Restricts length to 100 characters and removes HTML tags, angle brackets, and control characters.
 */
