...
/**
 * Sanitizes input by aggressively removing angle brackets and control characters,
 * and restricts input length to 100 characters to prevent unclosed tag XSS, HTML injection,
 * and mitigate prompt injection.
 */
