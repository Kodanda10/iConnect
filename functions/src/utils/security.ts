...
/**
 * Sanitizes input strings by limiting length and removing potentially dangerous characters
 * specifically targeting HTML tags, angle brackets, and control characters to prevent XSS and injection
 */
