...
/**
 * Sanitizes input by restricting length, removing HTML tags, angle brackets, and control characters.
 * Useful for preventing prompt injection and unclosed tag XSS.
 */
