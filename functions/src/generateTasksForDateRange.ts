 ...
 * - 2025-02-15: Optimized date matching
 */
...
export function generateTasksForDateRange(
    ...
    for (const date of dateRange(startDate, endDate)) {
        ...
        for (const constituent of constituents) {
            // Check Birthday
            if (isSameMonthAndDay(constituent.dob, targetMonth, targetDay)) {
            ...
            // Check Anniversary
            if (isSameMonthAndDay(constituent.anniversary, targetMonth, targetDay)) {
