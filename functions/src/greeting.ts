 ...
 * - 2024-12-17: Implemented Prompt Injection defense (sanitizeInput + XML delimiters)
 */
...
export function buildPrompt(request: GreetingRequest): string {
    ...
    return `<instruction>
Generate a warm and heartfelt ${occasion} greeting message${leaderMention} for the recipient.
