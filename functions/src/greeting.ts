...
The message is for the recipient specified in <recipient_name>.
${leaderName ? `The message is sent on behalf of the leader specified in <leader_name>.` : ''}
...
${leaderName ? `<leader_name>${leaderName}</leader_name>` : ''}`;
}
