...
export default function DataMetricsCard() {
    ...
    // Cache to track loaded blocks and prevent dependency on gpData state
    ...
    // Lazy load GP data on hover - Optimized with useRef cache
    const loadGPData = useCallback(async (blockName: string) => {
        ...
        try {
            ...
            loadedBlocks.current.delete(blockName); // Allow retry
        } finally {
