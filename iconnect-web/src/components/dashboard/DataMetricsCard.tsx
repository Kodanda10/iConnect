 ...
 * - 2025-01-22: Improved accessibility by making BlockItems focusable (button element)
 */
...
function BlockItem({ block, total, isHovered, onMouseEnter, onMouseLeave }: BlockItemProps) {
    ...
    return (
        <button
            ...
            className={`
                w-full text-left p-3 rounded-xl transition-all cursor-pointer relative overflow-hidden group focus:outline-none focus:ring-2 focus:ring-emerald-400/50
                ${isHovered
            ...
            onBlur={onMouseLeave}
            aria-label={`Show details for ${block.name}, ${block.count.toLocaleString()} constituents`}
