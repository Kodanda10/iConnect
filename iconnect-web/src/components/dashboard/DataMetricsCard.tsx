...
export default function DataMetricsCard() {
    ...
    // ⚡ Bolt: Stabilize hover handlers to prevent re-renders in memoized child components
                    ...
                    <div className="animate-fade-in space-y-4">
                        ...
                        {gpLoading[hoveredBlock] ? (
                            ...
                            <div className="space-y-3 max-h-[300px] overflow-y-auto pr-2 custom-scrollbar">
                                {(() => {
                                    // ⚡ Bolt: Calculate maxCount once outside the loop to avoid O(N²) calculation
...
// ⚡ Bolt: Memoize BlockItem to prevent re-renders when other blocks are hovered
...
// ⚡ Bolt: Memoize GPProgressBar to prevent re-renders when hover changes
