 ...
 * - 2025-05-21: Performance optimization - Memoized BlockItem and stabilized callbacks
 */
...
export default function DataMetricsCard() {
    ...
    // Use ref to track loaded blocks to keep loadGPData stable (no dependencies)
    ...
    // Lazy load GP data on hover - Stabilized with useRef to prevent re-creation
...
// Memoized to prevent unnecessary re-renders of all blocks when one is hovered
