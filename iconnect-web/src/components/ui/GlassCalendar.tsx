                ...
                <div className="flex items-center gap-1">
                    ...
                    <div className="relative dropdown-container">
                        <button
                            ...
                            aria-label={`Change month, current is ${monthNames[viewDate.getMonth()]}`}
                    ...
                    <div className="relative dropdown-container">
                        <button
                            ...
                            className="px-2 py-1 rounded-lg hover:bg-white/10 text-sm font-bold text-white flex items-center gap-1 transition-colors"
                            aria-label={`Change year, current is ${viewDate.getFullYear()}`}
                            aria-haspopup="listbox"
                ...
                {Array.from({ length: daysInMonth }, (_, i) => {
                    ...
                    return (
                        <button
                            ...
                            aria-label={`${day} ${monthNames[viewDate.getMonth()]} ${viewDate.getFullYear()}${isSelectedDay ? ', selected' : ''}`}
