        ...
        <div className={`bg-zinc-900 border border-white/10 shadow-2xl p-4 rounded-xl ${className}`} onClick={handleCalendarClick}>
            ...
            <div className="flex items-center justify-between mb-4">
                <button
                    ...
                    className="p-2 rounded-lg hover:bg-white/10 text-white/60 hover:text-white transition-colors focus-visible:ring-2 focus-visible:ring-emerald-500/50 outline-none"
                ...
                <div className="flex items-center gap-1">
                    ...
                    <div className="relative dropdown-container">
                        <button
                            ...
                            className="px-2 py-1 rounded-lg hover:bg-white/10 text-sm font-bold text-white flex items-center gap-1 transition-colors focus-visible:ring-2 focus-visible:ring-emerald-500/50 outline-none"
                ...
                {Array.from({ length: daysInMonth }, (_, i) => {
                    ...
                    return (
                        <button
                            ...
                            aria-label={`${date.toLocaleDateString('en-GB', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}${isSelectedDay ? ', selected' : ''}`}
                            aria-current={isTodayDay ? 'date' : undefined}
                            className={`
                                aspect-square flex items-center justify-center text-xs font-medium transition-all relative
                                border-r border-b border-white/5 focus-visible:ring-2 focus-visible:ring-emerald-500/50 outline-none
