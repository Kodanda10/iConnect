        ...
        <div className={`bg-zinc-900 border border-white/10 shadow-2xl p-4 rounded-xl ${className}`} onClick={handleCalendarClick}>
                ...
                <div className="flex items-center gap-1">
                    ...
                    <div className="relative dropdown-container">
                        <button
                            ...
                            aria-label={`Select month, current month is ${monthNames[viewDate.getMonth()]}`}
                            onClick={(e) => {
                                e.preventDefault();
                                e.stopPropagation();
                    ...
                    <div className="relative dropdown-container">
                        <button
                            ...
                            aria-label={`Select year, current year is ${viewDate.getFullYear()}`}
                            onClick={(e) => {
                                e.preventDefault();
                                e.stopPropagation();
            ...
            <div className="grid grid-cols-7 border-l border-white/5 relative bg-black/20 rounded-lg overflow-hidden">
                ...
                {Array.from({ length: daysInMonth }, (_, i) => {
                    ...
                    const fullDateString = `${day} ${monthNames[viewDate.getMonth()]} ${viewDate.getFullYear()}`;

                    return (
                        <button
                            key={day}
                            aria-label={fullDateString}
