            ...
            <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-1">
                    ...
                    <div className="relative dropdown-container">
                        ...
                        {showMonthDropdown && (
                            <div role="listbox" aria-label="Months" className="absolute top-full left-0 mt-1 bg-zinc-900/95 backdrop-blur-xl border border-white/10 rounded-xl shadow-2xl z-50 p-2 grid grid-cols-3 gap-1 w-40">
                    ...
                    <div className="relative dropdown-container">
                        ...
                        {showYearDropdown && (
                            <div role="listbox" aria-label="Years" className="absolute top-full right-0 mt-1 bg-zinc-900/95 backdrop-blur-xl border border-white/10 rounded-xl shadow-2xl z-50 p-2 max-h-48 overflow-y-auto w-24 scrollbar-thin scrollbar-thumb-white/20">
                                {years.map(year => (
                                    <button
                                        key={year}
                                        role="option"
