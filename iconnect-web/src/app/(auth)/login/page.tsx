            ...
            <div className="w-full max-w-md">
                ...
                <div className="glass-card p-8 animate-slide-up">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <button
                                    ...
                                    className="absolute right-4 top-1/2 -translate-y-1/2 text-white/40 hover:text-white/60 transition-colors focus:outline-none focus:text-white/80"
                        ...
                        {/* Error Message */}
                        {localError && (
                            <div role="alert" className="flex items-center gap-2 p-3 bg-red-500/20 border border-red-500/30 rounded-lg text-red-200 text-sm break-all">
