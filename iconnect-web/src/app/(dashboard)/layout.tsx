                    ...
                    <div className="glass-navbar flex items-center justify-between h-14 px-4 sm:px-6">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                className="relative p-2 rounded-full hover:bg-white/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50 transition-colors"
                            >
                            ...
                            <div className="hidden sm:flex items-center gap-2 pl-2 border-l border-white/20">
                                ...
                                <button
                                    onClick={() => signOut()}
                                    aria-label="Sign out"
                                    className="p-2 rounded-lg hover:bg-white/10 text-white/50 hover:text-red-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-400/50 transition-colors"
                                    title="Sign Out"
                                >
