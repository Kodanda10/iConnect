...
const firebaseConfig = {
    ...
    authDomain: process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN || 'iconnect-crm.firebaseapp.com',
    projectId: process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || 'iconnect-crm',
    storageBucket: process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || 'iconnect-crm.firebasestorage.app',
    messagingSenderId: process.env.NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID || '887016822564',
    appId: process.env.NEXT_PUBLIC_FIREBASE_APP_ID || '1:887016822564:web:dd5f49de3ef0138fe1c5b1',
};
