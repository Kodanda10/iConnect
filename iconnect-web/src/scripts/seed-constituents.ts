...
if (!firebaseConfig.apiKey) {
    console.error('CRITICAL: Firebase configuration missing! Ensure .env.local is set up correctly.');
    process.exit(1);
}
console.log('Using Environment Config for Project:', firebaseConfig.projectId);
